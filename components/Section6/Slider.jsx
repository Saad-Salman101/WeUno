    ...
    <div className="bg-[#F4F4F4] py-2">
      <div className="flex justify-around w-full align-center mt-10 mb-3">
        <div className="w-full ml-10">
          <div className=" text-[11px] tracking-[3px]">GET MOST FROM</div>
          <div className=" text-[26px] text-[#0065AB] my-3">Devices & Appliances</div>
          <div className=" text-[12px] tracking-[2px] underline">VIEW ALL PRODUCTS</div>
        </div>

        <div className=" flex justify-end mr-10">
          <div className="w-20 ">
            <img src="/assets/Section1/Left.png" alt="" className="swiper-button-prev6" />
          </div>
          <div className="w-20 ">
          <img src="/assets/Section1/Right.png" alt="" className="swiper-button-next6" />
          </div>
        </div>
      </div>
      <Swiper {...params}>
